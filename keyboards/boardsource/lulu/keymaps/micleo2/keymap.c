...
[_BSE] = LAYOUT(
  ...
  _______,       KC_Q,          GUI_T(KC_W),  CTL_T(KC_E),   KC_R,          KC_T,                                        KC_Y,          KC_U,          KC_I,         KC_O,          KC_P,          TG(_GME),
  _______,       KC_A,          BSE_S,        BSE_D,         BSE_F,         KC_G,                                        KC_H,          KC_J,          KC_K,         GUI_T(KC_L),   KC_SCLN,       OSL(Y),
...
[_GME] = LAYOUT(
  ...
  KC_NO,         KC_Z,          KC_X,         KC_C,          KC_V,          KC_B,          _______,       _______,       _______,       _______,       _______,      _______,       _______,       _______,
                                KC_LCTL,      KC_SPC,        KC_LALT,       _______,                                     G(A(KC_G)),    _______,       _______,      TG(_GME)
),
